    ...
    public class Program
    {
        public static void Main(string[] args)
        {
            Log.Logger = new LoggerConfiguration()
                ...
                .Destructure.ByTransforming<CustomerOrder>(co => new { StoreId = co.StoreId, CustomerName = co.CustomerName, LoyaltyId = co.LoyaltyId, OrderItemCount = co.OrderItems.Count })
